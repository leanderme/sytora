...
export default function Zipper_mouth(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <circle cx={32} cy={32} r={30} fill="#ffdd67" />
      <g fill="#696a6b">
        <path d="m47.9 43.9l-4 4c-.2.2-.2.4 0 .6l9.6 11.4c.1.1.4.2.5 0l5.9-5.9c.2-.2.2-.4 0-.6l-11.4-9.6c-.2-.1-.4-.1-.6.1m9.8 9.7c.1.1.1.4 0 .5l-3.7 3.6c-.1.1-.4.1-.5 0l-3.2-3.7 3.6-3.6 3.8 3.2" />
