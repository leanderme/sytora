...
export default function Rowboat(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <path d="m42.3 33.6l.7.2c.4.1.6.4.7.8.9.4 2 1.1 1.4 2.8-.1.3-.6 1.8-2.5 1.2-2.7-.9-2.7-.9-2-3l.5-1.4c.1-.5.7-.7 1.2-.6" fill="#ffdd67" />
      <path fill="#e0ac68" d="m42.3 42l4.5-13.4h-2.5l-4.4 13.2z" />
      <path fill="#7a5136" d="M49.3 43.9 61 41 3 37.2z" />
      <path d="m24.3 26.2v-1.3h-3.8v1.3c0 .7-.6 1.3-1.3 1.3h6.5c-.8 0-1.4-.5-1.4-1.3" fill="#ffdd67" />
      ...
      <path fill="#ffdd67" d="m61 53.9h-11.7v-8.6l11.7-2.2z" />
      ...
      <path d="m37.3 33.6l.7.2c.4.1.6.4.7.8.9.4 2 1.1 1.4 2.8-.1.3-.6 1.8-2.5 1.2-2.7-.9-2.7-.9-2-3l.5-1.4c.1-.5.6-.7 1.2-.6" fill="#ffdd67" />
      <g fill="#fbbf67">
        <path d="m30.9 56.3c-2.4-1-6.1 1.1-7.1 4.7h9.4c.9-2.2-.7-4-2.3-4.7" />
        <path d="m43.1 29.3c-.5 1.6-3.3 1.6-3.5 1.5-.2-.1-2.6-1.6-2.2-3.1.5-1.6.5-1.8 3.4-1s2.7 1.1 2.3 2.6" />
      </g>
      <path d="m11.1 13.9l1.2 2.1h20.3l.9-2.3c0-8.2-1.9-11.6-11-11.7-9.1-.1-11.4 3.5-11.4 11.9" fill="#ffb300" />
      <path d="m32.6 13.7c-.1.5-.2.9-.3 1.2-.2.4-.7.7-.7.7s.1-.9.1-2.2c-.5-7.5-1-3.9-9.3-3.9-8.3 0-8.7-3.6-9.3 3.9 0 1.3.1 2.2.1 2.2s-.5-.3-.7-.7c-.1-.3-.2-.7-.3-1.2-.8-.2-1.8 0-1.8 2.2 0 1.4.5 2.6 2.3 2.7.6 4.7 6.9 7.9 9.7 7.9 2.8 0 9.1-3.1 9.7-7.9 1.7-.1 2.3-1.3 2.3-2.7 0-2.2-1-2.4-1.8-2.2" fill="#ffdd67" />
      <g fill="#937237">
