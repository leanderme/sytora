...
export default function Boom(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path fill="#ef4e16" d="M44.7 35.4 64 24.7 42.3 25.7 48.8 12.4 37 20.7 38.5 2.4 30 17.5 17.1 0 22.6 21.8 3.4 15.4 18.7 29.4 0 33.1 18 37.2 7.9 55.1 24.4 45.2 25 64 31.8 46.8 40.9 60.4 40.4 44.1 56 50z" />
