...
export default function Bath_tone5(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path d="m50.9 36.4c2.2 3.7-4.2 6.6-7.8 6.6-3.6 0-12.3-1.3-10.6-5.2 1.8-4.1 8.9-11.4 12.5-11.4 3.6-.1 3.8 6.4 5.9 10" fill="#8a6859" />
      <g fill="#705041">
        <path d="M45.4,31.9C45,33,44,37.6,43,37.8" />
        <path d="m21.6 32.6l-11.8-.2c0 0 3.5 3.3 4.8 8l7-3.6c-.9-1.6 0-4.2 0-4.2" />
      </g>
      <path d="m4 31.4c-3.5-5.9-1.2-8.2-1.2-8.2.5-4.4 9.2-7.9 12.6-7.2 7 1.4 6.3 7.6 5.4 8l-8.5 7.3c0 0 2.6 6.6 7 6.3l-8.5 5.1-6.8-11.3" fill="#231f20" />
      <path d="m20.2 34.4c-3.1 1-3.7 2.4-8.4-3.7l2.1-1.2c0 0 1.7-.5.1-6.4-.7-2.7.9-6 2.4-4.9 3 2.3 2.2 4 3 4.6 1.5 1.2 2.5 0 3 1 .3.6-.7 1.2-.6 1.4.1.4.6.4 1.2.5.7 0 0 .9.7 1.7.8.9 1.1 1.2 1.1 1.2-.2.5-.8.8-.3 1.4 1 1.3 1.6 2.5-4.3 4.4" fill="#8a6859" />
      <path d="m18.6 23.4c-.2-.2-.3-.4-.4-.7-.1-.3-.2-.5-.3-.8-.2-.3-.4-.6-.8-.7-.3-.1-.6-.1-.9 0 .3.1.5.2.7.4.2.1.3.3.4.6.1.2.3.5.4.8.3.1.6.4.9.4" fill="#705041" />
      <path d="m9.8 31.9c1.3 1.3 3 1.6 3.9.7.9-.9.6-2.8-.6-4.1-1.3-1.3-3-1.6-3.9-.7-.9.9-.6 2.7.6 4.1" fill="#8a6859" />
