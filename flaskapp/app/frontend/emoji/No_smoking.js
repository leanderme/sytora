...
export default function No_smoking(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <circle cx={32} cy={32} r={30} fill="#ff5a79" />
      <circle cx={32} cy={32} r={24} fill="#333" />
      <path fill="#eda454" d="m12 32h15.4v8h-15.4z" />
      <path fill="#fff" d="m27.4 32h20.2v8h-20.2z" />
      <g fill="#ffce31">
        <ellipse cx="13.3" cy={36} rx=".7" ry=".9" />
        <path d="m14 33.4c0 .5-.3.9-.7.9-.4 0-.7-.4-.7-.9 0-.5.3-.9.7-.9.4.1.7.5.7.9" />
        ...
        <path d="m17.8 33.4c0 .5-.3.9-.7.9-.4 0-.7-.4-.7-.9 0-.5.3-.9.7-.9.4.1.7.5.7.9" />
        ...
        <path d="m21.2 33.4c0 .5-.3.9-.7.9s-.7-.4-.7-.9c0-.5.3-.9.7-.9.4.1.7.5.7.9" />
        ...
        <path d="m25.1 33.4c0 .5-.3.9-.7.9s-.7-.4-.7-.9c0-.5.3-.9.7-.9s.7.5.7.9" />
        ...
        <path d="m26.8 37.1c0 .5-.3.9-.7.9-.4 0-.7-.4-.7-.9 0-.5.3-.9.7-.9.4 0 .7.4.7.9" />
      ...
      <path fill="#ff8736" d="m47.6 32h2.4v8h-2.4z" />
      <path transform="matrix(.7071-.7071.7071.7071-13.2556 32.0003)" fill="#ff5a79" d="m29 2.8h6v58.4h-6z" />
      <path d="M30.6,11.9C27.5,23.7,37.1,7.5,49.5,31c-6.6-8.7-27.9-2.4-36.8-12C0.2,5.6,35.9-7.6,30.6,11.9z" fill="#abc2c6" />
    </svg>
  );
}
