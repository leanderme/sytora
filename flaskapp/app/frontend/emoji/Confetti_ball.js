...
export default function Confetti_ball(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <g fill="#42ade2">
        <path transform="matrix(.7071-.7071.7071.7071-18.6201 25.4129)" d="m19.4 33.2h4v4h-4z" />
        <path transform="matrix(.7071-.7071.7071.7071-25.0871 51.3699)" d="m47.5 54h4v4h-4z" />
      </g>
      <g fill="#83bf4f">
        <path transform="matrix(.7071-.7071.7071.7071-26.3413 26.4612)" d="m16.8 43h4v4h-4z" />
        <path transform="matrix(.7071-.7071.7071.7071-10.7864 31.5143)" d="m30.6 26.8h4v4h-4z" />
      </g>
      <g fill="#ed4c5c">
        <path transform="matrix(.7071-.7071.7071.7071-34.9053 27.6654)" d="m13.9 54h4v4h-4z" />
        <path transform="matrix(.7071-.7071.7071.7071-18.4185 46.6152)" d="m45.1 43.5h4v4h-4z" />
      </g>
      <g fill="#c28fef">
        <path transform="matrix(.7071-.7071.7071.7071-29.7046 39.3498)" d="m30.6 53.5h4v4h-4z" />
        <path transform="matrix(.7071-.7071.7071.7071-12.2172 41.704)" d="m42.2 33.6h4v4h-4z" />
      </g>
      <path transform="matrix(.7071-.7071.7071.7071-20.6923 36.2035)" fill="#ed4c5c" d="m31.4 41.1h4v4h-4z" />
    </svg>
  );
}
