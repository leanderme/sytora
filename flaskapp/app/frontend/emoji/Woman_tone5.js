...
export default function Woman_tone5(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <path d="m32 47c-4.2 0-6.3-3-4.2-3s6.3 0 8.4 0c2.1 0 0 3-4.2 3" fill="#705041" />
      ...
      <path d="M32,52l-10-1.5c6,8.5,14,8.5,20,0L32,52z" fill="#7d5442" />
      <path d="m35.9 50.1c-2.9-1.1-3.9.7-3.9.7s-1-1.8-3.9-.7c-2.3.9-6.1.4-6.1.4 4 .9 4.5 2.5 10 2.5 5.5 0 6-1.7 10-2.5 0 0-3.8.5-6.1-.4" fill="#5c3f34" />
