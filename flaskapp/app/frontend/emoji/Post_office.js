...
export default function Post_office(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlnsXlink="http://www.w3.org/1999/xlink" width={64} height={64} {...props}>
      ...
      <path fill="#e8e8e8" d="m6 14h52v46h-52z" />
      <path fill="#3e4347" d="m64 16h-64l5-16h54z" />
      <g fill="#62727a">
      ...
      <g fill="#fff">
        <path d="m11 44h42v16h-42z" />
        <path d="m32 41l13.5 6h4.5l-18-8-18 8h4.5z" />
      </g>
      <g fill="#f15744">
        <path d="m24 22h16v4h-16z" />
        <path d="m24 28h16v4h-16z" />
        <path d="m30 30h4v6h-4z" />
      </g>
      <path d="m64 16l-4.5-14.5-2.5 2.5-3-3 1-1h-3l1 1-3 3-3-3 1-1h-3l1 1-3 3-3-3 1-1h-3l1 1-3 3-3-3 1-1h-4l1 1-3 3-3-3 1-1h-3l1 1-3 3-3-3 1-1h-3l1 1-3 3-3-3 1-1h-3l1 1-3 3-2.5-2.5-4.5 14.5h5l-1-1 3-3 3 3-1 1h3l-1-1 3-3 3 3-1 1h3l-1-1 3-3 3 3-1 1h18l-1-1 3-3 3 3-1 1h3l-1-1 3-3 3 3-1 1h3l-1-1 3-3 3 3-1 1h5m-57-5l-3-3 3-3 3 3-3 3m7 0l-3-3 3-3 3 3-3 3m7 0l-3-3 3-3 3 3-3 3m22 0l-3-3 3-3 3 3-3 3m7 0l-3-3 3-3 3 3-3 3m7 0l-3-3 3-3 3 3-3 3" fill="#62727a" />
      ...
      <path d="m9 21.5c0 .3-.2.5-.5.5h-3c-.3 0-.5-.2-.5-.5v-3c0-.3.2-.5.5-.5h3c.3 0 .5.2.5.5v3" fill="#b2c1c0" id={0} />
      ...
      <path d="m55 21.5c0 .3.2.5.5.5h3c.3 0 .5-.2.5-.5v-3c0-.3-.2-.5-.5-.5h-3c-.3 0-.5.2-.5.5v3" fill="#b2c1c0" id={1} />
