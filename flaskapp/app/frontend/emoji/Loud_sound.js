...
export default function Loud_sound(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlnsXlink="http://www.w3.org/1999/xlink" width={64} height={64} {...props}>
      <g fill="#42ade2">
        <path d="M51.4,7.4L48.8,10c7,4.8,11.5,12.9,11.5,22c0,9.1-4.6,17.1-11.5,21.9l2.6,2.6C59.1,51,64,42.1,64,32
        			C64,21.9,59,12.9,51.4,7.4z" />
