...
export default function Nail_care_tone1(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path d="m20.6 35.1c-1.7-2.3-4.2-9.7-1.9-11.4l.7-.5c.4 2.7 1.7 6 2.7 7.4l22.7 31.4h13.6v-4.3l-23.7-32.8c-1.7-2.3-7.9-7-10.2-5.3l-5.7 4.1c-2.4 1.7.1 9.1 1.8 11.4l19.4 26.9-19.4-26.9" fill="#ffe1bd" />
      <path d="m19.4 23.2l-.7.5c-2.3 1.7.2 9.1 1.9 11.4l19.5 26.9h4.7l-22.7-31.3c-1-1.4-2.3-4.7-2.7-7.5" fill="#e6b796" />
      <path d="m48.2 16.7l-5.8 3.5c-2.3 1.4-.5 8.7.9 11l15.1 25.2-15.1-25.3c-1.4-2.3-3.2-9.6-.9-11l.4-.3c.2 2.5 1.1 5.4 1.9 6.8l13.6 22.6v-25.1l-.9-1.5c-1.3-2.3-6.9-7.3-9.2-5.9" fill="#ffe1bd" />
      <path d="m42.8 19.9l-.4.3c-2.3 1.4-.5 8.7.9 11l15.1 25.1v-7l-13.6-22.6c-.8-1.3-1.8-4.3-2-6.8" fill="#e6b796" />
      <path d="m14.3 43.1l-5.1 4.4c-2.1 1.8.9 8.6 2.6 10.7l3.2 3.8-3.3-3.8c-1.8-2.1-4.7-8.9-2.6-10.7l1-.8c.5 2.6 2.1 5.8 3.2 7.1l7 8.3h16.5l-12.4-14.7c-1.8-2-8.1-6-10.1-4.3" fill="#ffe1bd" />
      <path d="m13.3 53.7c-1.1-1.3-2.7-4.4-3.2-7.1l-1 .8c-2.1 1.8.9 8.6 2.6 10.7l3.3 3.9h5.3l-7-8.3" fill="#e6b796" />
