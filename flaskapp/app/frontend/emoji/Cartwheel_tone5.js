...
export default function Cartwheel_tone5(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <path d="m45.7 5.4l3.8 1.1c0 0-1.9 5.1-2.9 8.9-.3 1.2-1.2 1.6-1.6 2.1-2.4 3.1-7.1 6.4-7.1 6.4l-4.1-4.6c0 0 3.4-3.3 7-5.2.3-.2 1.7-1.3 1.9-2.4.3-2.4 2.6-4.3 3-6.3" fill="#8a6859" />
      <path d="m9.3 15.4l2.6-3c-.5-1.4-.8-1.6-.8-1.6-.5-.7-1.5-1-2.2-.5l-7 4.4c1.5 1.7 5.4 1.8 7.4.7" fill="#3e4347" />
      <path d="m11.9 12.4l-2.6 3c0 0 4.1 2.8 6.5 5.9.8 1 1.8 1 2.3 1.3 3.4 1.9 9 3 9 3l2-5.9c0 0-5.3-1.9-9.3-2.2-.4 0-1 0-1.8-.9-1.5-1.7-4.6-2.8-6.1-4.2" fill="#8a6859" />
      ...
      <path d="m31.5 54c-.1-.4-.2-.8-.1-1 .1-.4.4-.8.4-.8s.2.8.6 1.8c2.8 5.9 2 2.8 8.7.2 6.7-2.6 8.1.2 6.2-6-.4-1-.8-1.7-.8-1.7s.5.1.8.3c.2.2.4.5.6.8.7-.1 1.5-.5.7-2.4-.4-1.1-1.2-1.9-2.7-1.4-2-3.6-8-4.1-10.3-3.2-2.3.9-6.3 5.4-5.4 9.4-1.4.6-1.4 1.7-1 2.9.9 1.7 1.7 1.6 2.3 1.1" fill="#8a6859" />
      <g fill="#574137">
