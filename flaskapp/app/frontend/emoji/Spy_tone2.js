...
export default function Spy_tone2(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path d="m11.5 41.2h41.6c0-22.4-3.2-27.2-20.8-27.2s-20.8 4.8-20.8 27.2" fill="#dbb471" />
      <path d="m51.3 36.3c-.1.9-.3 1.7-.6 2.1-.4.8-1.4 1.3-1.4 1.3s.2-1.7.2-4c-1-13.9-1.8-10-17.3-10-15.4 0-24.2 2.7-24.2 12 0 6.8 6.4 9.9 6.4 9.9 1.6 6.7 6.2 10.4 13.4 13.7 2.2 1 6.6 1 8.8 0 8-3.6 12.7-7.8 13.8-15.9 3.2-.2 4.2-2.4 4.2-4.9.1-4.3-1.8-4.6-3.3-4.2" fill="#fed0ac" />
      <path d="m39.5 51.5c0 2.7-3.6 4.1-7.2 4.1s-7.2-1.4-7.2-4.1c0 0 0-.7.7-.7 3.2 0 9.7 0 13 0 .7 0 .7.7.7.7" fill="#664e27" />
      ...
      <path d="m40.3 37.7c0 .7.5 1.2 1.2 1.2.7 0 1.2-.5 1.2-1.2s-.5-1.2-1.2-1.2c-.7 0-1.2.5-1.2 1.2" fill="#231f20" />
      <path d="m47.5 38.1c0-5.6-11.2-5.6-11.2.8 1.6-4.8 9.6-4.8 11.2-.8" fill="#664e27" />
      <path d="m32.3 48.4c-3.3 0-5-2.4-3.3-2.4s5 0 6.7 0-.1 2.4-3.4 2.4" fill="#e0a372" />
      ...
      <g fill="#b0bdc6">
        <path transform="matrix(.5-.866.866.5-35.6058 35.404)" d="m11.8 47.1h2.2v2.9h-2.2z" />
        <path d="m13.2 48c5.9 3.4 13.4 1.4 16.8-4.5 3.4-5.9 1.4-13.4-4.5-16.8-5.9-3.4-13.4-1.4-16.8 4.5-3.4 5.9-1.4 13.4 4.5 16.8m-2.6-15.7c2.8-4.8 9-6.5 13.8-3.7 4.8 2.8 6.5 9 3.7 13.8-2.8 4.8-9 6.5-13.8 3.7s-6.5-9-3.7-13.8" />
      </g>
      <path transform="matrix(.5001-.866.866.5001-41.4948 35.3982)" fill="#333" d="m4.7 51h10.3v5.2h-10.3z" />
