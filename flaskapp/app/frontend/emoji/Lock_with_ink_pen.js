...
export default function Lock_with_ink_pen(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <path d="m45.8 31.4h11.2l2.8 11.4c0 0-5 4-7.3 10.4v-14.1c.3-.3.6-.8.6-1.2 0-.9-.8-1.7-1.7-1.7-.9 0-1.7.8-1.7 1.7 0 .5.2.9.6 1.2v14.1c-2.3-6.4-7.3-10.4-7.3-10.4l2.8-11.4" fill="#fff" />
      <path d="m62 0c0 12.9-2.2 17.7-2.2 17.7v13.7h-16.8v-13.7c0 0-2.2-4.8-2.2-17.7-.1 0 21.2 0 21.2 0" fill="#3e4347" />
      <path fill="#94989b" d="m43 17.7h16.8v2.2h-16.8z" />
    </svg>
  );
}
