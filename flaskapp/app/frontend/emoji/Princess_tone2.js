...
export default function Princess_tone2(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path d="M32,2C13.9,2,4,13.4,4,28.5V62h56V28.5c0-22.4-15.2-22-15.2-22S43.7,2,32,2z" fill="#dbb471" />
      <path d="m10.4 40.7c0 0-4.4-1.1-4.4-7.5 0-5.1 3.3-5.9 3.3-5.9 30.2-.1 38.7-6.3 38.7-6.3s1.9 6.2 6.6 6.2c0 0 3.4.6 3.4 5.9 0 6.4-4.5 7.5-4.5 7.5-.1 9.7-13.4 21.4-21.5 21.4-8.1 0-21.6-11.7-21.6-21.3" fill="#fed0ac" />
      ...
      <path d="M32,52l-10-1.5c6,8.5,14,8.5,20,0L32,52z" fill="#e07297" />
      <path d="m35.9 50.1c-2.9-1.1-3.9.7-3.9.7s-1-1.8-3.9-.7c-2.3.9-6.1.4-6.1.4 4 .9 4.5 2.5 10 2.5s6-1.7 10-2.5c0 0-3.8.5-6.1-.4" fill="#b85d7b" />
