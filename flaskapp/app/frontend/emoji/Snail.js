...
export default function Snail(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path d="m29.6 42.8c0 0-4.7-20.8-13.1-20.8-15.1 0-15.5 27.8-5.3 37 3.1 2.8 16.1 2.8 43.5 0 2.9-.3 1.8-3.1-2.3-5-2.7-1.3-15.8-3.7-22.8-11.2" fill="#94d82a" />
      <g fill="#769e2a">
      ...
      <path d="m9.6 26.1c0 1.2.4 2.3 1.1 2.9.3.3.7.5 1.1.7.2.1.4.1.6.1 0 0 .3 0 .4 0 .1 0 .2 0 .3 0 .9 0 1.8-.3 2.5-.9.7-.6 1.2-1.6 1.6-2.8.4 1.2.4 2.6-.4 3.8-.8 1.2-2.3 1.9-3.7 1.9-.2 0-.3 0-.5 0-.2 0-.3 0-.5-.1-.4-.1-.7-.2-1.1-.3-.7-.3-1.3-.8-1.6-1.5-.7-1.2-.6-2.8.2-3.8" fill="#3e4347" />
      <path d="m58.9 42.3c3.4-4.3 3.9-11.2 2-15.4-2.8-6.2-8.3-7.1-8.3-7.1-7.4-11.9-27.8-11.9-34 2.7 5.3 3.1 8.3 11.8 10 16.5 1.6 6.3 4.7 12 9.8 13.5 2.2.6 2.6-1.7 2.6-1.7 1.4 2 4.3 3.4 6.9 2.7 9.7-2.8 11-11.2 11-11.2" fill="#e08828" />
      <g fill="#94d82a">
      ...
      <path d="m15.4 13c0 3.7-2.9 6.6-6.4 6.6-3.6 0-6.4-3-6.4-6.6 0-3.7 2.9-6.6 6.4-6.6 3.5 0 6.4 3 6.4 6.6" fill="#fcfcfa" />
      <path d="m14.6 13c0 2.5-2 4.6-4.4 4.6-2.4 0-4.4-2-4.4-4.6 0-2.5 2-4.6 4.4-4.6 2.5.1 4.4 2.1 4.4 4.6" fill="#3e4347" />
      <g fill="#93603b">
      ...
      <path d="m34.3 12.7c0 5.4-4.4 9.7-9.8 9.7-5.4 0-9.8-4.4-9.8-9.7 0-5.4 4.4-9.7 9.8-9.7 5.4 0 9.8 4.4 9.8 9.7" fill="#94d82a" />
      <ellipse cx="22.7" cy="13.1" rx="7.4" ry="7.6" fill="#fcfcfa" />
      <path d="m29.3 13.1c0 2.9-2.3 5.3-5.1 5.3-2.8 0-5.1-2.4-5.1-5.3 0-2.9 2.3-5.3 5.1-5.3 2.8 0 5.1 2.4 5.1 5.3" fill="#3e4347" />
    </svg>
  );
}
