...
export default function Waxing_gibbous_moon(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path d="M32,2c-9.4,0-17,13.4-17,30s7.6,30,17,30c16.6,0,30-13.4,30-30S48.6,2,32,2z" fill="#ffe8a6" />
      <path d="m15 32c0-16.6 7.6-30 17-30-16.6 0-30 13.4-30 30s13.4 30 30 30c-9.4 0-17-13.4-17-30" fill="#3e4347" />
      <g fill="#f4dc9f">
