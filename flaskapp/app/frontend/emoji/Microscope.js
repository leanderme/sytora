  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <g fill="#333">
        ...
        <path transform="matrix(.7067-.7076.7076.7067-21.5895 21.6604)" d="m14.5 28.7h1.6v16.3h-1.6z" />
      </g>
      <path transform="matrix(.7067-.7076.7076.7067-20.4508 22.1324)" fill="#29abe2" d="m15.7 27.6h1.6v16.3h-1.6z" />
    </svg>
  );
}
