...
export default function Squid(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <g fill="#9c323c">
        <ellipse transform="matrix(.7091-.7052.7052.7091-12.7393 30.2502)" cx="30.3" cy="30.6" rx="3.9" ry=".4" />
        <ellipse transform="matrix(.7106-.7036.7036.7106-13.4602 31.8638)" cx={32} cy="32.3" rx="4.6" ry=".3" />
