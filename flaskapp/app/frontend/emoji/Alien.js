...
export default function Alien(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path d="M59.5,30.6C59.5,54.1,32,62,32,62S4.5,54.1,4.5,30.6C4.5,13.1,15.5,2,32,2C48.5,2,59.5,13.1,59.5,30.6z" fill="#c7e755" />
      <g fill="#454749">
      ...
      <path d="m32 48.6c-7.6 0-10.7-3.7-10.7-2.4 0 1.9 4.8 4.4 10.7 4.4s10.7-2.5 10.7-4.4c0-1.3-3.1 2.4-10.7 2.4z" fill="#454749" stroke="#454749" strokeMiterlimit={10} />
    </svg>
  );
}
