...
export default function Cookie(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <g fill="#dda85f">
        <path d="m50.1 10.8l-1.4 1.4-1.3-1.4 1.3-1.3z" />
      ...
      <path d="m43.8 36.7c1.1-.3 2.8-3.7 1-3.9-3.1-.5-5.5 1-5.2 2.7.3 1.7 3.4 1.4 4.2 1.2" fill="#a37f6a" />
      ...
      <path transform="matrix(.7071-.7071.7071.7071-4.1299 22.1932)" fill="#6d4934" d="m23.3 14.7h2.8v2.8h-2.8z" />
      <g fill="#dda85f">
        <path transform="matrix(.7069-.7073.7073.7069-18.8143 21.6132)" d="m15.3 32.1h2.8v2.8h-2.8z" />
        <path transform="matrix(.7071-.7071.7071.7071-20.9511 39.0836)" d="m35.3 43.4h2.8v2.8h-2.8z" />
        <path transform="matrix(.7071-.7071.7071.7071-17.6007 36.0363)" d="m32.8 37.4h3.8v3.8h-3.8z" />
        <path transform="matrix(.7071-.7071.7071.7071 1.0787 22.2721)" d="m25.5 7.9h3.8v3.8h-3.8z" />
      </g>
      <g fill="#6d4934">
        <path transform="matrix(.7071-.7071.7071.7071-20.1126 44.0843)" d="m41.7 44.9h2.8v2.8h-2.8z" />
        <path transform="matrix(.7071-.7071.7071.7071-9.967 46.4574)" d="m49.7 33.8h2.8v2.8h-2.8z" />
        <path transform="matrix(.7071-.7071.7071.7071-4.8567 37.5067)" d="m42.1 23.9h1.4v1.4h-1.4z" />
        <path transform="matrix(.7071-.7071.7071.7071-22.7604 21.5789)" d="m14 37.6h1.4v1.4h-1.4z" />
      </g>
    </svg>
  );
}
