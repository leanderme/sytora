...
export default function Stadium(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlnsXlink="http://www.w3.org/1999/xlink" width={64} height={64} {...props}>
      <g fill="#62727a">
        <path d="m32.5 11.5c0 .3-.2.5-.5.5-.3 0-.5-.2-.5-.5v-11c0-.3.2-.5.5-.5.3 0 .5.2.5.5v11" />
        <path d="m23.5 11.5c0 .3-.2.5-.5.5-.3 0-.5-.2-.5-.5v-11c0-.3.2-.5.5-.5.3 0 .5.2.5.5v11" />
        <path d="m41.5 11.5c0 .3-.2.5-.5.5-.3 0-.5-.2-.5-.5v-11c0-.3.2-.5.5-.5.3 0 .5.2.5.5v11" />
      </g>
      ...
      <path d="m54.2 22.8c-8.5-3.7-35.7-3.9-43.8 0-.3.1-.6.3-.8.5 12.1 2.3 32.6 2.1 44.9-.4-.1 0-.2 0-.3-.1" fill="#83bf4f" id={0} />
      <path fill="#62727a" d="m0 39.3h64v24.7h-64z" />
      <g fill="#b2c1c0">
        <path d="m11.2 12.7c-.3 0-.5.1-.8.2l5.9 5.9c.3 0 .6-.1.9-.1l-6-6" />
        <path d="m53.7 12.9c-.3 0-.5-.1-.8-.2l-6 6c.3 0 .6.1.9.1l5.9-5.9" />
        <path d="m32.5 17.5v-6.8c-.3 0-.7 0-1 0v6.8c.3 0 .7 0 1 0" />
      </g>
      <use xlinkHref="#0" />
      <path d="m18.5 24.5l1-2h12v2.5c.3 0 .7 0 1 0v-2.5h12l.9 1.8c.3 0 .6-.1 1-.1l-1.4-2.7h-26l-1.5 3c.3 0 .6 0 1 0" fill="#f9f3d9" />
      <path d="m64 18.2c0 .6-.2 1.1-.7 1.5-8.7 6.7-56.3 7.3-62.9 0-.3-.3-.4-.7-.4-1.1v20.8c0 8.2 64 10.2 64-1v-20.2" fill="#b2c1c0" />
      ...
      <path d="m37 36h-10c-1.1 0-2 .9-2 2v10h14v-10c0-1.1-.9-2-2-2" fill="#b2c1c0" />
      <path fill="#62727a" d="m28 40h8v9.3h-8z" />
      <g fill="#fff">
        <path d="m0 34.7v1.5c5 4.3 21.3 5.4 25 5.7v-1.2c-12.9-.8-22.7-3.2-25-6" />
        <path d="m64 34c-2.2 3.7-11.3 6.2-25 6.8v1.2c6.6-.3 20.4-1.5 25-6.3v-1.7" />
        <path d="m0 29.7v1.5c5 4.3 21.3 5.4 25 5.7v-1.2c-12.9-.8-22.7-3.2-25-6" />
        <path d="m64 29c-2.2 3.7-11.3 6.2-25 6.8v1.2c6.6-.3 20.4-1.5 25-6.3v-1.7" />
        <path d="m0 24.7v1.5c5 4.3 21.3 5.4 25 5.7v-1.2c-12.9-.8-22.7-3.2-25-6" />
        <path d="m64 24c-2.2 3.7-11.3 6.2-25 6.8v1.2c6.6-.3 20.4-1.5 25-6.3v-1.7" />
      </g>
      <g fill="#62727a">
