...
export default function Speak_no_evil(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <path fill="#89664c" d="m14.9 52l-8.3 10h12.9l4-3.6z" />
      <path d="m20.2 43.3c0 0 4.9-4.5 9.5-3.9 2.3.3-7.1 7.6-7.1 7.6s9.7-8.2 11.7-5.6c1.8 2.3-8.9 9.8-8.9 9.8s10-8.1 9.6-4.6c-.3 3.9-7.9 12.9-12.5 13.8-6.6 1.3-11.8-2.9-8.3-17.5 1.8-7.3 3.6.8 6 .4" fill="#ffd6bb" />
      <path fill="#89664c" d="M48.3 50.2 59 62 45 62 42.8 59.4z" />
      <path d="m38.2 43.7c0 0-6.2-2.3-10.3 0-2 1.1 9.4 4.3 9.4 4.3s-12.1-3.9-13-.8c-.8 2.9 12 5.7 12 5.7s-12.3-3.7-10.7-.5c1.8 3.4 12.2 8.9 16.8 8 6.8-1.4-1.8-17.3-4.2-16.7" fill="#ddb199" />
      <path d="m39.6 43.7c0 0-6.2-2.3-10.3 0-2 1.1 9.4 4.3 9.4 4.3s-12.1-3.9-13-.8c-.8 2.9 12 5.7 12 5.7s-12.3-3.7-10.7-.5c1.8 3.4 12.2 8.9 16.8 8 6.6-1.3 9.8-7.2 1-19.4-4.3-6.1-2.9 2.1-5.2 2.7" fill="#ffd6bb" />
    </svg>
  );
}
