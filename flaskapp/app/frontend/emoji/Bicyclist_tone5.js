...
export default function Bicyclist_tone5(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path fill="#8a6859" d="m25.1 16.1l2.1-2.6 3.9 9.3-6.1 2.5z" />
      <path d="m22.8 22.1c2.2.4 2.2 3.2 2.2 3.2 2.5-1 2.2-6.6.9-9.6l-3.1 6.4" fill="#705041" />
      <path d="m21.8 3.2l-9.2 8.2c-.3 3.1 1.2 4 1.6 5.1.2.5-.4 1.8-.8 2.4-.7 1.5 1.5 1.5 2.2 1.1.9.9-.2 2.1 2.8.1 0 0-2.7 2.8-.1 2.4.3 1.4 1.1 4 6.8-1.4 1.7-1.6 1-5.4 1-5.4l3.1-2-7.4-10.5" fill="#8a6859" />
      <path d="m13.8 5.4c6.1-5.3 11.5-3.2 12.9-1.9 3.6 3.6 4.1 9.1 2.3 14.1 0 0-1.8 0-2.9-1.9 0 0 2.1.1 1.3-4-.7-3.4-4.7-3.7-4.6 1.3l-.5.2c-1.8-1.8-1.3-5.2-4.1-5-2.5.2-5.6 3.8-5.6 3.8-1.3-1-1.3-4.4 1.2-6.6" fill="#231f20" />
      <path d="m16.8 15.4c.3.7.1 1.4-.4 1.6-.5.2-.8-.3-1.1-1-.3-.7-.4-1.3.1-1.5.5-.1 1.1.2 1.4.9" fill="#574137" />
      <path d="m24 13.5c-.6-1.3.1-2.9 1.2-3.4 0 0-1.2 2.3.1 4.3 0 0-.9 0-1.3-.9" fill="#705041" />
      <path d="m19.3 19.4c0 0-.9 1.5-1.3 2-.8.9-1 .6-.7 0 .3-.5 1-1.2 1-1.2l1-.8" fill="#574137" />
      <g fill="#3b946f">
        <path d="m25 24.3l-1.6 7.4 3.1.5.7-6.3z" />
        <path d="m26.5 31.8c-.2-.8-1-1.3-1.9-1.1l-6 1.4.7 3 6-1.4c.9-.2 1.4-1.1 1.2-1.9" />
      </g>
      <path d="m19.4 33.5l-.2-1.5c-.1-.5-.6-.9-1.1-.8l-.7.1c-.4 0-.7.3-.8.7-1 .2-2.2.7-2 2.5 0 .3.2 1.9 2.2 1.7 2.9-.5 2.9-.5 2.6-2.7" fill="#705041" />
      ...
      <path d="m20.9 34.1l-.4-1.4c-.1-.5-.7-.8-1.2-.7l-.7.2c-.4.1-.6.4-.7.8-.9.3-2.1 1-1.6 2.7.1.3.5 1.9 2.4 1.3 2.8-.8 2.8-.8 2.2-2.9" fill="#8a6859" />
