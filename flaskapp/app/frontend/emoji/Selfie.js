...
export default function Selfie(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <path d="m4.9 43.8l4.8 2.9c.9.5 2 .3 2.6-.6.6-.8.3-2-.6-2.5l-4.8-2.9c-.9-.5-2-.3-2.6.6-.5.8-.2 2 .6 2.5" fill="#eba352" />
      ...
      <path d="m12.8 51.5c0 1.3-1 2.3-2.3 2.3h-4.2c-1.3 0-2.3-1-2.3-2.3v-7.7c0-1.3 1-2.3 2.3-2.3h4.3c1.3 0 2.3 1 2.3 2.3v7.7z" fill="#ffdd67" />
      <path d="m53.4 24.9v4.2c0 .8.6 1.4 1.4 1.4.8 0 1.4-.6 1.4-1.4v-4.2c0-.8-.6-1.4-1.4-1.4s-1.4.6-1.4 1.4" fill="#eba352" />
      <path d="m60 34.1c0 .9-.8 1.7-1.7 1.7h-3.2c-.9 0-1.7-.8-1.7-1.7v-5.8c0-.9.8-1.7 1.7-1.7h3.2c.9 0 1.7.8 1.7 1.7v5.8" fill="#ffdd67" />
      ...
      <path d="M22.4,16.7l1.4,2.6h25.1l1.1-2.8C50,6.4,47.6,2.1,36.5,2C25.2,1.9,22.4,6.4,22.4,16.7z" fill="#ffb300" />
      <path d="m49 16.5c-.1.6-.2 1.1-.4 1.4-.3.6-.9.9-.9.9s.2-1.1.1-2.7c-.6-9.3-1.2-4.8-11.4-4.8-10.2 0-10.8-4.5-11.4 4.8-.1 1.6.1 2.7.1 2.7s-.6-.3-.9-.9c-.2-.3-.3-.9-.4-1.4-1-.3-2.2 0-2.2 2.8 0 1.7.6 3.2 2.8 3.3.8 5.8 8.5 9.7 12 9.7 3.5 0 11.3-3.9 12-9.7 2.1-.2 2.8-1.6 2.8-3.3 0-2.9-1.3-3.1-2.2-2.8" fill="#ffdd67" />
      <g fill="#937237">
