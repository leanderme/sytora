...
export default function Moneybag(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <path d="m24.2 53.7c0 0-.3.8 1.1.9l-3.7 3.1c0 0-2.2-.2-2.7 1.3 0 0-9-1-14.8-3.6 0 0 1.2-.9-.3-1.5 0 0 1.7-1.2 2.1-2.3 0 0 1.6.2 2.1-1 .2-.1 6.2 3.5 16.2 3.1z" fill="none" stroke="#699635" strokeMiterlimit={10} />
      ...
      <path d="m39.1 46.9c0 0 .5.8-1.1 1.1l4.2 3.3c0 0 2.4-.6 3.2.8 0 0 10-1.8 14.6-4.2 0 0-1.5-.7 0-1.6 0 0-1.8-1.5-2.5-2.5 0 0-1.7.5-2.6-.7 0 .1-3.6 3.3-15.8 3.8z" fill="none" stroke="#699635" strokeMiterlimit={10} />
