...
export default function Cry(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <path d="m54 31c0 5-4 9-9 9-5 0-9-4-9-9 0-5 4-9 9-9 5 0 9 4 9 9" fill="#fff" />
      <circle cx={45} cy={31} r={6} fill="#664e27" />
      <g fill="#fff">
        <ellipse cx="46.6" cy="35.5" rx="2.8" ry="3.2" />
        <ellipse cx="42.8" cy={31} rx="1.6" ry="1.9" />
        <path d="m28 31c0 5-4 9-9 9-5 0-9-4-9-9 0-5 4-9 9-9 5 0 9 4 9 9" />
      </g>
      ...
      <path d="m47 36c-5.1 6.8-8 13-8 18.1 0 4.4 3.6 7.9 8 7.9 4.4 0 8-3.5 8-7.9 0-5.1-3-11.4-8-18.1" fill="#65b1ef" />
      <g fill="#917524">
        <path d="m53.2 20.7c-3.2-2.7-7.5-3.9-11.7-3.1-.6.1-1.1-2-.4-2.2 4.8-.9 9.8.5 13.5 3.6.6.5-1 2.1-1.4 1.7" />
        <path d="m22.5 17.4c-4.2-.7-8.5.4-11.7 3.1-.4.4-2-1.2-1.4-1.7 3.7-3.2 8.7-4.5 13.5-3.6.7.2.2 2.3-.4 2.2" />
      </g>
    </svg>
  );
}
