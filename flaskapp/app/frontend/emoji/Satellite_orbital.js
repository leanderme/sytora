...
export default function Satellite_orbital(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlnsXlink="http://www.w3.org/1999/xlink" width={64} height={64} {...props}>
      ...
      <g fill="#3e4347">
        <path transform="matrix(.7073-.7069.7069.7073-18.2947 29.8994)" d="m25.9 36.4h2.1v1.3h-2.1z" />
        <path transform="matrix(.7071-.7071.7071.7071-8.1867 34.0994)" d="m36 26.3h2.1v1.3h-2.1z" />
      </g>
