...
export default function Deer(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      ...
      <path d="m42.7 39.4c-2.5-4.5.5-7.3-1.4-8.6-3.2-2.2-6.4-2.3-9.3-2.3-2.9 0-6.1.1-9.3 2.3-1.9 1.2 1.1 4.1-1.4 8.6s-.2 8.4 2.8 11.1c3 2.6.2 8.4 4.4 10.6 1 .5 2.2 1 3.5 1 1.3 0 2.5-.5 3.5-1 4.2-2.2 1.4-7.9 4.4-10.6 3.1-2.7 5.4-6.6 2.8-11.1" fill="#d3976e" />
      <g opacity=".5">
        <path d="m41.7 35.9c.1 1 .3 2.2 1.1 3.5 2.5 4.5.2 8.4-2.8 11.1-1.3 1.1-1.5 2.7-1.7 4.4 0-2.4.2-6.7 1.9-11.1 1.4-3.9 1.5-5.8 1.5-7.9" fill="#89664c" />
      </g>
      <g opacity=".5">
        <path d="m22.3 35.9c-.1 1-.3 2.2-1.1 3.5-2.5 4.5-.2 8.4 2.8 11.1 1.3 1.1 1.5 2.7 1.7 4.4 0-2.4-.2-6.7-1.9-11.1-1.4-3.9-1.5-5.8-1.5-7.9" fill="#89664c" />
      </g>
      <path d="m27.5 35.7c0 0 0-15.3-14.5-15.3-.1 0 0 15.3 14.5 15.3" fill="#d3976e" />
      <path d="m15.4 22.6c0 0 5.5 0 9.6 7.6 0 0-3.3-1.8-2.8-1 .5.8 2.9 2.6.4 1.7-2.4-.9-.8.7 0 1.5.8.7-7.2-1.5-7.2-9.8" fill="#89664c" />
      <path d="m36.5 35.7c0 0 0-15.3 14.5-15.3.1 0 0 15.3-14.5 15.3" fill="#d3976e" />
      <g fill="#89664c">
      ...
      <path d="m32 53.9c-2 0-4.5.3-4.5 1.4s1.8 3.6 4.5 3.6c2.7 0 4.5-2.5 4.5-3.6s-2.5-1.4-4.5-1.4" fill="#594640" />
      <ellipse cx={32} cy="55.4" rx="3.3" ry=".9" fill="#fff" />
      <g fill="#3e4347">
        <ellipse transform="matrix(.9848-.1737.1737.9848-6.9915 4.7359)" cx="23.6" cy="42.3" rx="1.7" ry="2.4" />
        <ellipse transform="matrix(.1737-.9848.9848.1737-8.2527 74.7834)" cx="40.4" cy="42.3" rx="2.4" ry="1.7" />
      </g>
      <g fill="#89664c">
