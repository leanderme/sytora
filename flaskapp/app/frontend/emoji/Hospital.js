...
export default function Hospital(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" width={64} height={64} {...props}>
      <path d="m40 18h-26c-2.2 0-4 1.8-4 4v38h34v-38c0-2.2-1.8-4-4-4" fill="#e8e8e8" />
      <g fill="#62727a">
        <path d="m60 36h-34c-1.1 0-2 .9-2 2v22h38v-22c0-1.1-.9-2-2-2" />
        <path d="m7 36c-.6 0-1.2.4-1.6.8l-2.9 4.3c-.3.5-.5 1.4-.5 1.9v17h8v-24h-3" />
      </g>
      <path fill="#b4d7ee" d="m12 53h10v7h-10z" />
      <path d="m63 60h-62c-.6 0-1 .5-1 1v2c0 .6.4 1 1 1h62c.5 0 1-.4 1-1v-2c0-.5-.5-1-1-1" fill="#62727a" />
      <g fill="#b4d7ee">
      ...
      <g fill="#fff">
        <path d="m21 53h-8-1v1 6h1v-6h3.5v6h1v-6h3.5v6h1v-6-1z" />
      ...
      <path d="m33 44h29v-2h-31c-.5 0-1 .5-1 1v17h2v-3c0-.5.5-1 1-1h29v-2h-29c-.5 0-1-.4-1-1v-2c0-.5.5-1 1-1h29v-2h-29c-.5 0-1-.5-1-1v-2c0-.5.5-1 1-1" fill="#fff" />
      <g fill="#b4d7ee">
      ...
      <path fill="#b2c1c0" d="m19 8h16v10h-16z" />
      <circle cx={27} cy={8} r={8} fill="#e8e8e8" />
      <path d="m32 6h-3v-3c0-.5-.5-1-1-1h-2c-.5 0-1 .5-1 1v3h-3c-.5 0-1 .4-1 1v2c0 .6.5 1 1 1h3v3c0 .6.5 1 1 1h2c.5 0 1-.4 1-1v-3h3c.5 0 1-.4 1-1v-2c0-.6-.5-1-1-1" fill="#f15744" />
    </svg>
  );
}
